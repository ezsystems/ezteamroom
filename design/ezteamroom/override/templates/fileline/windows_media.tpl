{def $icon_size='normal'
     ...
     $download_link    = concat( "content/download/", $attribute.contentobject_id, "/", $attribute.id, "/file/", $attribute.content.original_filename )
...
<div id="ai{$node.node_id}" style="display:none;" class="{$style} file-infobox float-break">
        ...
        <tr>
            ...
            <td class="{$style}"><a href={concat("content/download/",$version.data_map.file.contentobject_id,"/",$version.data_map.file.id,"/file/",$version.data_map.file.content.original_filename)|ezurl}> {"Get version"|i18n("design/standard/content/version")}</a></td>
        </tr>
        {/foreach}
        </table>
</div>
