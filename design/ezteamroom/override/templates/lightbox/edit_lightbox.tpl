...
<div class="content-edit">
    ...
    <div class="attribute-header">
        <h1 class="long">{'Edit %1 - %2'|i18n( 'ezteamroom/lightbox', , array( $class.name|wash, $object.name|wash ) )}</h1>
    </div>
    ...
    <input class="defaultbutton" type="submit" name="PublishButton" value="{'Store'|i18n( 'ezteamroom/lightbox' )}" />
    <input class="button" type="submit" name="DiscardButton" value="{'Cancel'|i18n( 'ezteamroom/lightbox' )}" />
