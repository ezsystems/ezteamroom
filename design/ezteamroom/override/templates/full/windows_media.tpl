...
<div class="content-view-full">
    ...
    {def $attribute=$node.data_map.file}
        ...
        <param name="filename" value={concat("content/download/",$attribute.contentobject_id,"/",$attribute.content.contentobject_attribute_id,"/",$attribute.content.original_filename|rawurlencode() )|ezurl} />
