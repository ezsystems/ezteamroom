...
{if and( $object.data_map.image.has_content, is_set( $object.data_map.image.content.search-thumbnail ) )}

   {def $image = $object.data_map.image.content.search-thumbnail}
