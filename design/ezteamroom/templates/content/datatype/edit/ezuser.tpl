...
{* Username. *}
<div class="element">
    <label>{'Username'|i18n( 'ezteamroom/membership' )}:</label>
...
{* Password #1. *}
<div class="element">
    <label>{'Password'|i18n( 'ezteamroom/membership' )}:</label>
...
{* Password #2. *}
<div class="element">
    <label>{'Confirm password'|i18n( 'ezteamroom/membership' )}:</label>
...
{* Email. *}
<div class="element">
    <label>{'Email'|i18n( 'ezteamroom/membership' )}:</label>
