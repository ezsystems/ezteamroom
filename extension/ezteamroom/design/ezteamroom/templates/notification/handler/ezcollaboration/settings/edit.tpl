{def $handlerlist = $handler.collaboration_handlers
     $selection = $handler.collaboration_selections}

<div class="block">
<fieldset>
    <legend>{"Collaboration notification"|i18n("ezteamroom/collaboration")}</legend>

<p>{"Choose which collaboration items you want to get notifications for."|i18n("ezteamroom/collaboration")}</p>

<input type="hidden" name="CollaborationHandlerSelection" value="1" />

{section name=Handlers loop=$handlerlist}
